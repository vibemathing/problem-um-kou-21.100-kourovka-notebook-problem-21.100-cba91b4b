...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.100-kourovka-notebook-problem-21.100-cba91b4b-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.100"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.100-kourovka-notebook-problem-21.100-cba91b4b-v1",
      "problem_contract_sha256": "d9cbddb71bbc51533210a07c3bf9610a6f7bc20e8c4d206a88b8327673483127",
      "problem_id": "problem:um-kou-21.100-kourovka-notebook-problem-21.100-cba91b4b",
      "route_id": "route:um-kou-21.100-kourovka-notebook-problem-21.100-cba91b4b-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.100-kourovka-notebook-problem-21.100-cba91b4b-source-fidelity-01",
      "graph_id": "graph:um-kou-21.100-kourovka-notebook-problem-21.100-cba91b4b-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.100-kourovka-notebook-problem-21.100-cba91b4b-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.100-kourovka-notebook-problem-21.100-cba91b4b-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Suppose that $A$ and $G$ are finite groups such that $A$ acts coprimely on $G$ by automorphisms. Let $C=C_G(A)$ be the fixed-point subgroup, and let $C'$ denote its derived subgroup. Is it true that the number of $A$-invariant irreducible characters $\\chi$ of $G$ whose restriction $\\chi_C$ is never zero is exactly $|C/C'|$?"
          },
          "statement_sha256": "7cad67c87c2211acf80c8a83f3d2192adca9c6f581d69f28d937ee1490984437"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.100-kourovka-notebook-problem-21.100-cba91b4b-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.100-kourovka-notebook-problem-21.100-cba91b4b-root",
      "route_id": "route:um-kou-21.100-kourovka-notebook-problem-21.100-cba91b4b-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.100-f53117ff474e",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.100"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
